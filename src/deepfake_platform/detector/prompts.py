...
1.  **Biological Signals Analysis**:
    ...
    *   **Skin**: Look for unnatural smoothness, lack of fine pores, or inconsistent aging signs.
    *   **Mouth**: Check for "gliding lips", lack of inner-mouth detail, or incongruent shadowing.

2.  **Physics & Environment Analysis**:
    *   **Lighting**: Does the lighting on the face match the background? Are shadows consistent?
    *   **Boundaries**: Check jawline and hair for blurring/warping where face mask meets background.
    *   **Physics**: Do hair strands move naturally? Do accessories maintain their structure?
